$j(document).ready(function(){
    ...
    $j(document).keydown(function(event) {
        if ($j('#confirmPatientModalDiv').is(':visible') ){
            console.log("confirmPatientModalDiv is visible keydown event");
            return;
        }else if ($j('#confirmExistingPatientModalDiv').is(':visible') ){
            if (event.keyCode ==38){
                //user pressed up arrow
                if(selectedMatchItem === null){
                    selectedMatchItem=1;
                ...
                console.log("confirmExistingPatientModalDiv is visible ENTER KEY");
                //User pressed enter key.
                event.stopPropagation();
                event.preventDefault();
                if((selectedMatchItem!==null)){
        ...
        } else if ($j('#confirmPrintDiv').is(':visible') ){
            if (event.keyCode ==38){
                //user pressed up arrow
        ...
        } else if ($j('#confirmPossibleLocalityModalDiv').is(':visible') ){
            if (event.keyCode ==38){
                //user pressed up arrow
                if(selectedLocalityItem === null){
        ...
        buttons: [
            ...
            },
            {
                ...
                click: function(event) {
                    console.log("okBtnConf has been clicked");
                    alertUserAboutLeaving = false;
                    ...
                    event.preventDefault();
                    setTimeout('$j("#confirmPatientModalDiv").dialog("close"); ', 500);
                }
            }
        ]
    });
